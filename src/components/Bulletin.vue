<template>
    <div class="book_bulletin" style="background:#fff">
        <!--导航栏部分-->
        <div class="nb_top">
        ...
        <div class="xxbg">
            ...
            <div class="prev_next">
                <div class="prev"><img src="http://127.0.0.1:3000/img/nbook/left.png" alt=""></div>
                <!-- 轮播图 -->
                <div class="tempwrap">
                    <!-- 轮播图 -->
                    <div class="wrap">
                    ...
                    <!-- 左箭头 -->
                    <!-- 右箭头 -->
                    <div class="next"><img src="http://127.0.0.1:3000/img/nbook/right.png" alt=""></div>
                </div>
            </div>
...
<!--                 <select>
            ...
            <div class="booklist">
                <ul>
                    <li class="bookitem" v-for="item in list" :key="item.nid">
                        <div class="book_img">
                            <img :src="'http://127.0.0.1:3000/'+item.pic"></div>
                        <div class="book_intr">
            ...
            <div class="contents">
                ...
                <div class="content" v-for="tmp in row" :key="tmp.id">
                    ...
                    <div class="nbook">
                        <ul>
                            <li><a href="javascript:;">{{tmp.title}}</a></li>
                            <li>{{tmp.author}}</li>
                            <li>浏览次数：76</li>
                        </ul>
                    </div>
...
div.xxbg{
    height: 620px;
    background: url('http://127.0.0.1:3000/img/bjbg.png') no-repeat scroll 0 0 #ff7f38;
}
